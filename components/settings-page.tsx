    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">알림 및 사용자 설정을 관리합니다</p>
        </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>고객 가입일을 기준으로 케어 알림을 설정합니다</CardDescription>
        </CardHeader>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateJoinAlerts("day90", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateJoinAlerts("day180", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateJoinAlerts("day270", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateJoinAlerts("day365", checked)}
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateJoinAlerts("customEnabled", checked)}
              />
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>계약 상령일을 기준으로 갱신 알림을 설정합니다</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-3 gap-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateRenewalAlerts("day60", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateRenewalAlerts("day30", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateRenewalAlerts("day7", checked)}
              />
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>알림 발송 채널의 우선순위와 fallback 조건을 설정합니다</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value) => updateNotificationChannels("priority", value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateNotificationChannels("kakao", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateNotificationChannels("sms", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateNotificationChannels("phone", checked)}
              />
            </div>
            <div className="flex items-center justify-between">
              ...
              <Switch
                ...
                onCheckedChange={(checked) => updateNotificationChannels("email", checked)}
              />
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>설계사 정보 및 알림 발신자명을 설정합니다</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
